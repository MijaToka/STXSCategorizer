...
cConstantSpline::cConstantSpline(const TString &filename)
    : filename_(filename), spline_(nullptr) {}

void cConstantSpline::initspline(bool isDbkg) {
  if (!spline_) {
    TFile *f_ = TFile::Open(filename_);
    spline_.reset(
        (TSpline3 *)(f_->Get("sp_gr_varReco_Constant_Smooth")->Clone()));
    f_->Close();
  }
  assert(spline_.get());
}
...
extern "C" float getDVBF2jetsConstant_shiftWP(float ZZMass, bool useQGTagging,
                                              float newWP) {
...
extern "C" float getDVBF1jetConstant_shiftWP(float ZZMass, bool useQGTagging,
                                             float newWP) {
...
extern "C" float getDWHhConstant_shiftWP(float ZZMass, bool useQGTagging,
                                         float newWP) {
...
extern "C" float getDZHhConstant_shiftWP(float ZZMass, bool useQGTagging,
                                         float newWP) {
...
extern "C" float
getDbkgVBFdecConstant(int ZZflav, float ZZMass) { // ZZflav==id1*id2*id3*id4
  if (abs(ZZflav) == 11 * 11 * 11 * 11 ||
      abs(ZZflav) == 2 * 11 * 11 * 11 * 11 ||
      abs(ZZflav) == 2 * 11 * 11 * 2 * 11 * 11)
    return DbkgVBFdecSpline4l.eval(ZZMass, true);
  if (abs(ZZflav) == 11 * 11 * 13 * 13 ||
      abs(ZZflav) == 2 * 11 * 11 * 13 * 13 ||
      abs(ZZflav) == 2 * 11 * 11 * 2 * 13 * 13)
    return DbkgVBFdecSpline2l2l.eval(ZZMass, true);
  if (abs(ZZflav) == 13 * 13 * 13 * 13 ||
      abs(ZZflav) == 2 * 13 * 13 * 13 * 13 ||
      abs(ZZflav) == 2 * 13 * 13 * 2 * 13 * 13)
    return DbkgVBFdecSpline4l.eval(ZZMass, true);
  std::cout << "Invalid ZZflav " << ZZflav << std::endl;
  assert(0);
  return 0;
}

extern "C" float getDbkgVHdecConstant(int ZZflav,
                                      float ZZMass) { // ZZflav==id1*id2*id3*id4
  if (abs(ZZflav) == 11 * 11 * 11 * 11 ||
      abs(ZZflav) == 2 * 11 * 11 * 11 * 11 ||
      abs(ZZflav) == 2 * 11 * 11 * 2 * 11 * 11)
    return DbkgVHdecSpline4l.eval(ZZMass, true);
  if (abs(ZZflav) == 11 * 11 * 13 * 13 ||
      abs(ZZflav) == 2 * 11 * 11 * 13 * 13 ||
      abs(ZZflav) == 2 * 11 * 11 * 2 * 13 * 13)
    return DbkgVHdecSpline2l2l.eval(ZZMass, true);
  if (abs(ZZflav) == 13 * 13 * 13 * 13 ||
      abs(ZZflav) == 2 * 13 * 13 * 13 * 13 ||
      abs(ZZflav) == 2 * 13 * 13 * 2 * 13 * 13)
    return DbkgVHdecSpline4l.eval(ZZMass, true);
...
extern "C" float getDbkgkinConstant(int ZZflav,
                                    float ZZMass) { // ZZflav==id1*id2*id3*id4
  if (abs(ZZflav) == 11 * 11 * 11 * 11 ||
      abs(ZZflav) == 2 * 11 * 11 * 11 * 11 ||
      abs(ZZflav) == 2 * 11 * 11 * 2 * 11 * 11)
    return DbkgkinSpline4e.eval(ZZMass, true);
  if (abs(ZZflav) == 11 * 11 * 13 * 13 ||
      abs(ZZflav) == 2 * 11 * 11 * 13 * 13 ||
      abs(ZZflav) == 2 * 11 * 11 * 2 * 13 * 13)
    return DbkgkinSpline2e2mu.eval(ZZMass, true);
  if (abs(ZZflav) == 13 * 13 * 13 * 13 ||
      abs(ZZflav) == 2 * 13 * 13 * 13 * 13 ||
      abs(ZZflav) == 2 * 13 * 13 * 2 * 13 * 13)
    return DbkgkinSpline4mu.eval(ZZMass, true);
  std::cout << "Invalid ZZflav " << ZZflav << std::endl;
  assert(0);
  return 0;
}
